...
/* Refactoring UI: Categorical data scale (HSL Monochromatic Indigo Scale - Crisp High Contrast) */
export const INITIAL_CHANNEL_DATA: ChannelShare[] = [
  { name: 'Direct / Inbound', value: 54200, pct: 36.5, color: 'hsl(215, 68%, 34%)' },
  { name: 'Organic Search', value: 32800, pct: 22.1, color: 'hsl(215, 58%, 44%)' },
  { name: 'Partner Referral', value: 24600, pct: 16.6, color: 'hsl(215, 48%, 54%)' },
  { name: 'Paid Social', value: 19400, pct: 13.1, color: 'hsl(215, 38%, 64%)' },
  { name: 'Product-Led Growth', value: 17450, pct: 11.7, color: 'hsl(215, 30%, 72%)' },
];
